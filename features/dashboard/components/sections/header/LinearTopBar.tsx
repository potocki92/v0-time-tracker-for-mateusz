    ...
    <header className="sticky top-0 z-40 -mx-3 hidden border-b border-hairline bg-surface-0/85 px-3 py-2 backdrop-blur-md md:-mx-4 md:flex md:items-center md:justify-between md:px-4 xl:-mx-8 xl:px-8">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          onClick={onBellClick}
          className="relative inline-flex h-8 w-8 items-center justify-center rounded-md border border-hairline bg-surface-1 text-zinc-400 transition hover:bg-surface-3 hover:text-white"
        >
          <Bell className="h-4 w-4" aria-hidden />
          {notificationsCount > 0 && (
            <span className="absolute right-1.5 top-1.5 block h-1.5 w-1.5 rounded-full bg-emerald-500 ring-2 ring-surface-1" />
          )}
        </button>
