  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={6}
        className="min-w-[260px] rounded-xl border border-[#1a1a1a] bg-[#0a0a0a] p-1.5 text-zinc-200 shadow-2xl"
      >
        ...
        <DropdownMenuGroup>
          <DropdownMenuSub>
            ...
            <DropdownMenuSubContent
              sideOffset={4}
              className="min-w-[180px] rounded-xl border border-[#1a1a1a] bg-[#0a0a0a] p-1.5 text-zinc-200 shadow-2xl"
            >
