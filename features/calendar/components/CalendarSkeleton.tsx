...
export function CalendarSkeleton() {
  return (
    <div className="min-h-screen bg-surface-0" data-testid="section-skeleton">
      <div className="flex h-12 items-center gap-3 border-b border-hairline bg-surface-0/80 px-4 sm:h-14">
      ...
      <PageContainer>
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:grid-cols-4">
          {[0, 1, 2, 3].map((i) => (
            <Card key={i} className="rounded-lg border-hairline bg-surface-1 py-0 shadow-none">
        ...
        {/* Calendar */}
        <Card className="rounded-lg border-hairline bg-surface-1 shadow-none">
          <CardContent className="space-y-3 p-3 sm:p-4">
            ...
            <div className="grid grid-cols-7 gap-1 sm:gap-1.5">
              {Array.from({ length: 35 }).map((_, idx) => (
                <div
                  key={idx}
                  className="h-16 space-y-1.5 rounded-lg border border-hairline bg-surface-1 p-1.5 sm:h-24 sm:p-2"
                >
