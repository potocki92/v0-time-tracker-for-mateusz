    ...
    <div className="space-y-3">
      ...
      <div className="grid gap-2 sm:grid-cols-[1fr_auto]">
        <Button
          ...
          variant="outline"
          onClick={handleAdd}
          className="h-12 w-full justify-center gap-2 rounded-xl border-dashed border-hairline text-sm font-medium text-muted-foreground hover:text-foreground sm:h-11"
        >
