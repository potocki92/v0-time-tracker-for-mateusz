        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            >
              <SelectTrigger
                id="client-work-type"
                className="h-12 w-full rounded-xl border-border/70 bg-background px-4 text-[0.95rem] shadow-sm"
              >
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              ...
              className="h-12 w-full rounded-xl border-border/70 bg-background px-4 text-[0.95rem] shadow-sm disabled:opacity-60"
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
