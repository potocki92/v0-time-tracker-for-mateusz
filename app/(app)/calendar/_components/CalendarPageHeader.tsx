...
export function CalendarPageHeader({
  ...
  return (
    <div className="sticky top-0 z-30 border-b bg-card/50 backdrop-blur-sm">
      <div className="container flex h-12 items-center gap-2.5 px-4 sm:h-14 sm:gap-3">
        <div className="flex items-center gap-2">
          <div className="flex h-7 w-7 items-center justify-center rounded-md bg-primary/10">
            <CalendarDays className="h-4 w-4 text-primary" />
          </div>
          <h1 className="text-sm font-semibold tracking-tight">Kalendarz</h1>
        </div>
        ...
        <div className="ml-auto flex items-center gap-2 text-[11px] text-muted-foreground">
          ...
          <span className="sm:hidden rounded-full bg-muted px-2 py-0.5 font-medium text-foreground/80">
            {workDays}d
          </span>
        </div>
      </div>
