    ...
    <div className="flex h-full flex-col gap-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="lv2-t11 font-semibold text-white">{DEMO_MONTH.label}</span>
          <span className="flex gap-0.5">
            <span className="flex size-4 items-center justify-center rounded border border-[var(--lv2-hair-2)] lv2-t8 text-zinc-400">
              ‹
            </span>
            <span className="flex size-4 items-center justify-center rounded border border-[var(--lv2-hair-2)] lv2-t8 text-zinc-400">
              ›
      ...
      <Card className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-x-2.5 gap-y-1 border-t border-[var(--lv2-hair)] pt-2">
          <Eyebrow>Statusy</Eyebrow>
          {STATUS_LEGEND.map((status) => (
            <span key={status.label} className="flex items-center gap-1 lv2-t8 text-zinc-400">
