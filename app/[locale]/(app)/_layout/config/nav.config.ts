...
const SECTION_QUICK_ACTIONS: Partial<Record<WorkspaceSegment, NavQuickAction>> = {
  projects: { href: '/projects?new=1', labelKey: 'quickActions.addProject' },
  clients:  { href: '/clients?new=1',  labelKey: 'quickActions.addClient' },
}
