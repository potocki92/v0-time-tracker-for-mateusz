...
import { planDays, type DayDecision, type WeekSchedule } from '@/features/work-automation/domain'
 ...
 * podglad w ustawieniach — kalendarz na landingu nie moze wiec pokazac dnia,
...
export function buildDemoMonth(): DemoMonth {
  ...
  const days = decisions.map((decision, index): DemoDay => ({
    ...
    // KLUCZ powodu, nie etykieta: tlumaczenie nalezy do warstwy UI.
